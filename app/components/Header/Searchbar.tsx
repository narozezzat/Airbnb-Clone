        ...
        <>
            ...
            {input && (
                <div className='absolute top-[100%] left-[50%] flex flex-col col-span-3 mx-auto translate-x-[-50%]'>
                    ...
                    <div className='flex gap-4 items-center bg-white p-5'>
                        <button
                            type='button'
                            className='flex-grow border p-2 rounded-lg text-gray-500'
                            onClick={() => setInput('')}
                        >
                            Cancel
                        </button>
                        <Link
                            ...
                            onClick={() => setInput('')}
                            className='flex-grow text-center p-2 rounded-lg bg-red-400 text-white'
                        >
                            Search
                        </Link>
                    </div>
